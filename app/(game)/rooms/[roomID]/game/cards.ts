...
const cards: CardImage[] = [
  { id: 1, name: "one", color: "normal", imageSrc: NormalOne.src },
  { id: 2, name: "two", color: "green", imageSrc: GreenTwo.src },
  { id: 3, name: "three", color: "green", imageSrc: GreenThree.src },
  { id: 4, name: "four", color: "green", imageSrc: GreenFour.src },
  { id: 5, name: "five", color: "normal", imageSrc: NormalFive.src },
  { id: 6, name: "six", color: "green", imageSrc: GreenSix.src },
  { id: 7, name: "seven", color: "normal", imageSrc: NormalSeven.src },
  { id: 8, name: "eight", color: "green", imageSrc: GreenEight.src },
  { id: 9, name: "nine", color: "normal", imageSrc: NormalNine.src },
  { id: 10, name: "bal", color: "green", imageSrc: GreenBal.src },
  { id: 11, name: "chung", color: "red", imageSrc: RedChung.src },
  //
  ...
  { id: 21, name: "bal", color: "green", imageSrc: GreenBal.src },
  { id: 22, name: "chung", color: "red", imageSrc: RedChung.src },
  //
  ...
  { id: 32, name: "bal", color: "green", imageSrc: GreenBal.src },
  { id: 33, name: "chung", color: "red", imageSrc: RedChung.src },
  //
  { id: 34, name: "one", color: "red", imageSrc: RedOne.src },
  { id: 35, name: "two", color: "red", imageSrc: RedTwo.src },
  { id: 36, name: "three", color: "red", imageSrc: RedThree.src },
  { id: 37, name: "four", color: "red", imageSrc: RedFour.src },
  { id: 38, name: "five", color: "red", imageSrc: RedFive.src },
  { id: 39, name: "six", color: "red", imageSrc: RedSix.src },
  { id: 40, name: "seven", color: "red", imageSrc: RedSeven.src },
  { id: 41, name: "eight", color: "red", imageSrc: RedEight.src },
  { id: 42, name: "nine", color: "red", imageSrc: RedNine.src },
  { id: 43, name: "bal", color: "green", imageSrc: GreenBal.src },
  { id: 44, name: "chung", color: "red", imageSrc: RedChung.src },
  //
];
