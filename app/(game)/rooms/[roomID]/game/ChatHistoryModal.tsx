...
const ChatHistoryModal = ({ setIsOpen }: ChatHistoryModalProps) => {
  return (
    <div className="absolute left-0 top-0 w-full h-full bg-black/50 flex justify-center items-center py-12">
      <div className="bg-white max-w-3xl w-full rounded-xl p-8 h-full flex flex-col gap-4">
        <ul className="w-full border border-black overflow-y-auto h-[calc(100%-48px)]"></ul>
